               ...
               if(isset($_POST['submit']))
                 {
                      ...
                      {
                            $sql = "update other_task SET task='$task',role='$role',filename='$a' WHERE otid='$otid' and fid='$fid'";
                            $res = mysqli_query($conn,$sql);
                            if($res===true)
                            {
                                   echo "<script type='text/javascript'>alert('Record Updated with File')</script>";
                                   echo "<script>location.href = 'view_other_task.php'</script>";
                            }
                            else
                            {
                      ...
                      else
                      {
                             ...
                             $sql = "update other_task SET task='$task',role='$role' WHERE otid='$otid' and fid='$fid'";
                            $res = mysqli_query($conn,$sql);
                            if($res===true)
                            {
