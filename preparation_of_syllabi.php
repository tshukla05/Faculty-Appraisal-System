...
<html>
    <head>
        ...
        <title>Preparation Of Syllabi| Faculty Appraisal</title>
     ...
     <?php include('user_header.php'); ?>
          ...
          <div class="row"></div>
           ...
           <div class="row">
                ...
                <h5 class="left-align">i).Preparation of syllabi:</h5>
          </div>
               ...
               <div class="center">
                ...
                <div id="modal1" class="modal modal-fixed-footer">
                      ...
                      <div class="modal-footer">
                            ...
                            <a href="admission_process.php" class="modal-action modal-close waves-effect waves-green btn-flat ">Yes</a>
                            <a href="preparation_of_syallabi.php" class="modal-action modal-close waves-effect waves-green btn-flat ">No</a>
