...
<!DOCTYPE html>
  <html>
    ...
    <div class="nav-wrapper #ef5350 red lighten-1">
      <a href="#" class="brand-logo" style="font-family:titlefont">Faculty Appraisal</a>
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        ...
        <li><a href="index_of_forms.php">Index</a><li>
        <li><a href="viewform.php">Offline Forms</a><li>
        <li><a href="view_circulars.php">Circulars</a><li>
        <li><a href="feedback.php">Feedback Form</a><li>
        <li><a href="signout.php"><i class="material-icons">settings_power</i></a></li>
      </ul>
    </div>
  </nav>
