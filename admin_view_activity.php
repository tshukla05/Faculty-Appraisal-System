        ...
        <div class="row">
          ...
          <table class="bordered stripped responsive-table">
                       ...
                       while($row = mysqli_fetch_array($res))
                      {
                          ...
                          if($GLOBALS['fn'] == 'None')
                          {
                              echo "<tr>
                                ...
                                <td><button class='btn' type='submit' name='change_file' value='".$row[0]."' formaction='admin_remove_file_activity.php' disabled>Remove_File</button></td>
                          ...
                          else
                          {
                             ...
                             echo "<tr>
                                ...
                                <td><button name='submit' type='submit' id='".$row[0]."' value='".$row[0]."'>
                                <i class='material-icons prefix'>delete</i></button></td>
                                <td><button class='btn' type='submit' name='change_file' value='".$row[0]."' formaction='admin_remove_file_activity.php'>Remove_File</button></td>
                                  </tr>";
                          }        
             ...
             <div class="row center">
                    <button class="btn" type="submit" name="edit" id="edit" formaction="admin_edit_activity.php" disabled>Edit Record</button>&nbsp;&nbsp;&nbsp;&nbsp;
                    <a class="btn" href="search_activity.php">Search Record</a>&nbsp;&nbsp;&nbsp;
                    <a class="btn" href="empty_activity.php">Empty Table</a>
                  </tr>
