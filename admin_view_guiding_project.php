  ...
  <html>
    <head>
        <link type="text/css" rel="stylesheet" href="css/materialize.min.css"  media="screen,projection"/>
          ...
          <link rel="icon" href="fevicon.ico" type="image/gif" sizes="16x16">
          <title> View Guiding Project | Faculty Appraisal</title>
    </head>
    <body>
        ...
        <div class="row">
          ...
          <table class="bordered stripped responsive-table">
             ...
             <div class="row center">
                    <button class="btn" type="submit" name="edit" id="edit" formaction="admin_edit_guiding_project.php" disabled>Edit Record</button>&nbsp;&nbsp;&nbsp;&nbsp;
                    <a class="btn" href="search_guiding_project.php">Search Record</a>&nbsp;&nbsp;&nbsp;
                    <a class="btn" href="admin_empty_guiding_project.php">Empty Table</a>
                  </tr>
                    ...
                    class Record
                    {
                        function delete_record()
                        {
                            if(isset($_POST['submit']))
                            {
                                ...
                                $did = $_POST['submit'];
                                $sql = "delete from guide_project where gid='$did'";
                                $res = mysqli_query($conn,$sql);
                                if($res===TRUE)
                                {
                                ...
                                else
                                {
                                      ...
                                      echo "<script>location.href = 'admin_view_supervised_project.php'</script>";
